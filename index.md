...
<li><a href="#_troubleshooting">8.2.2. Troubleshooting</a>
<ul class="sectlevel4">
...
<li><a href="#_logstash">39.1.5. Logstash</a>
<ul class="sectlevel4">
...
<ul class="sectlevel2">
<li><a href="#_安装配置_16">45.1. 安装配置</a>
<ul class="sectlevel3">
...
<div class="content">
<pre class="highlightjs highlight"><code data-lang="bash" class="language-bash hljs">virsh attach-disk tpl_win2k12r2 /data/libvirt/iso/win2k12r2.iso hdc --type cdrom --mode readonly</code></pre>
</div>
</div>
<div class="listingblock">
...
<div class="sect3">
<h4 id="_创建数据库时指定字符集">7.1.1. 创建数据库时指定字符集</h4>
<div class="listingblock">
<div class="content">
...
<div class="sect3">
<h4 id="_新建或修改密码开放指定host登录">7.1.2. 新建或修改密码、开放指定HOST登录</h4>
<div class="dlist">
<dl>
...
<div class="content">
<pre class="highlightjs highlight"><code data-lang="bash" class="language-bash hljs">update user set host = '%'  where user ='root';
...
<div class="content">
<pre class="highlightjs highlight"><code data-lang="bash" class="language-bash hljs">ALTER USER 'root'@'%' IDENTIFIED BY 'geek';
flush privileges;</code></pre>
</div>
</div>
<div class="listingblock">
...
<div class="content">
<pre class="highlightjs highlight"><code data-lang="bash" class="language-bash hljs">grant all privileges on *.*  to root@"172.17.%.%" identified by "geek";
...
<div class="sect3">
<h4 id="_本机无密码登录">7.1.3. 本机无密码登录</h4>
<div class="listingblock">
<div class="content">
...
<div class="sect3">
<h4 id="_临时启用性能调优">7.1.7. 临时启用性能调优</h4>
<div class="listingblock">
<div class="content">
...
<div class="sect3">
<h4 id="_设置root密码">8.1.12. 设置root密码</h4>
<div class="listingblock">
<div class="content">
...
<div class="sect3">
<h4 id="_安装grub引导">8.1.14. 安装Grub引导</h4>
<div class="sect4">
...
<div class="sect3">
<h4 id="_设置pacman">8.1.17. 设置pacman</h4>
<div class="paragraph">
...
<div class="sect3">
<h4 id="_安装常用软件">8.1.18. 安装常用软件</h4>
<div class="paragraph">
...
<div class="sectionbody">
<div class="sect2">
<h3 id="_centos6初始化">13.1. CentOS6初始化</h3>
<div class="listingblock">
<div class="content">
...
<div class="sect2">
<h3 id="_centos7初始化">13.2. CentOS7初始化</h3>
<div class="listingblock">
<div class="content">
...
<div class="sect2">
<h3 id="_centos8初始化">13.3. CentOS8初始化</h3>
<div class="listingblock">
<div class="content">
...
<div class="sect2">
<h3 id="_centos7_install_lnmp">13.4. CentOS7 Install LNMP</h3>
<div class="sect3">
<h4 id="_安装_nginx">13.4.1. 安装 Nginx</h4>
<div class="listingblock">
...
<div class="sect3">
<h4 id="_安装_mysql">13.4.2. 安装 MySQL</h4>
<div class="listingblock">
...
<div class="sect3">
<h4 id="_安装_php7">13.4.3. 安装 PHP7</h4>
<div class="listingblock">
...
<div class="sect3">
<h4 id="_lnmp_环境测试">13.4.4. LNMP 环境测试</h4>
<div class="listingblock">
...
<div class="sect2">
<h3 id="_centos8配置文档">13.5. CentOS8配置文档</h3>
<div class="sect3">
<h4 id="_安装_nginx_2">13.5.1. 安装 Nginx</h4>
<div class="listingblock">
...
<div class="sect3">
<h4 id="_安装_mysql_2">13.5.2. 安装 MySQL</h4>
<div class="listingblock">
<div class="title">安装 MySQL</div>
<div class="content">
...
<div class="sect3">
<h4 id="_安装_php7_2">13.5.3. 安装 PHP7</h4>
<div class="listingblock">
...
<div class="sect3">
<h4 id="_lnmp环境测试">13.5.4. LNMP环境测试</h4>
<div class="listingblock">
<div class="title">增加数据库</div>
<div class="content">
<pre class="highlightjs highlight"><code data-lang="bash" class="language-bash hljs">mysql -uroot -pgeek -e 'create database drupal;grant all privileges on drupal.* to drupal@"localhost" identified by "drupal_password";flush privileges;'</code></pre>
...
<div class="sect2">
<h3 id="_centos8安装前加载驱动">13.6. CentOS8安装前加载驱动</h3>
<div class="paragraph">
...
<div class="sect3">
<h4 id="_dell_precision_t3600">13.6.1. Dell Precision T3600</h4>
<div class="paragraph">
...
<div class="sectionbody">
<div class="sect2">
<h3 id="_centos7安装配置">21.1. CentOS7安装配置</h3>
<div class="dlist">
<dl>
...
<dd>
<p>ssh://git@git.xxx.com:2222/用户名/项目名称.git</p>
</dd>
<dt class="hdlist1">HTTP克隆地址</dt>
<dd>
<p><a href="https://git.xxx.com:2035/用户名/项目名称.git" class="bare">https://git.xxx.com:2035/用户名/项目名称.git</a></p>
</dd>
</dl>
</div>
<div style="page-break-after: always;"></div>
...
<div class="sectionbody">
<div class="sect2">
<h3 id="_centos7_install_python38">24.1. CentOS7 Install Python38</h3>
<div class="sect3">
...
<div class="sect2">
<h3 id="_centos8_install_python38">24.2. CentOS8 Install Python38</h3>
<div class="sect3">
...
<div class="listingblock">
<div class="content">
<pre class="highlightjs highlight"><code data-lang="bash" class="language-bash hljs">wget http://dl.cdgeekcamp.com/centos/8/python/3/python-3.8.3-1.el8.x86_64.tar.gz -O python-3.8.3-1.el8.x86_64.tar.gz
...
<div class="sect2">
<h3 id="_ubuntu_install_python38">24.3. Ubuntu Install Python38</h3>
<div class="sect3">
<h4 id="_编译安装_3">24.3.1. 编译安装</h4>
<div class="listingblock">
<div class="content">
<pre class="highlightjs highlight"><code data-lang="bash" class="language-bash hljs">mkdir ~/downloads
cd  ~/downloads
...
<div class="sect3">
<h4 id="_二进制压缩包安装_3">24.3.2. 二进制压缩包安装</h4>
<div class="paragraph">
<p><strong>Ubuntu 18.04</strong></p>
</div>
<div class="listingblock">
<div class="content">
<pre class="highlightjs highlight"><code data-lang="bash" class="language-bash hljs">wget http://dl.cdgeekcamp.com/ubuntu/18.04/python-3.8.3-1~ubuntu18.04_amd64.tar.gz -O python-3.8.3-1~ubuntu18.04_amd64.tar.gz
...
<div class="sect2">
<h3 id="_设置pip国内镜像">24.4. 设置PIP国内镜像</h3>
<div class="sect3">
<h4 id="_临时使用">24.4.1. 临时使用</h4>
<div class="listingblock">
<div class="content">
...
<div class="sect2">
<h3 id="_上传_pypi">24.5. 上传 <code>PyPI</code></h3>
<div class="paragraph">
<p>官方文档：</p>
</div>
<div class="paragraph">
...
<div class="sect2">
<h3 id="_pycharm">24.6. Pycharm</h3>
<div class="sect3">
<h4 id="_disable_and_suppress_inspections">24.6.1. Disable and suppress inspections</h4>
<div class="paragraph">
<p>官方文档：</p>
</div>
<div class="paragraph">
...
<div class="sect2">
<h3 id="_安装使用">26.1. 安装使用</h3>
<div class="sect3">
<h4 id="_安装certbot">26.1.1. 安装certbot</h4>
<div class="listingblock">
<div class="content">
<pre class="highlightjs highlight"><code data-lang="bash" class="language-bash hljs">pip38 install certbot

ln -s /usr/local/python-3.8.1/bin/certbot /usr/local/bin/certbot</code></pre>
</div>
</div>
</div>
<div class="sect3">
<h4 id="_申请方式一dns方式申请通配符域名证书">26.1.2. 申请方式一：DNS方式申请通配符域名证书</h4>
<div class="sect4">
<h5 id="_申请通配符域名验证一">申请通配符域名验证（一）</h5>
<div class="listingblock">
<div class="content">
...
<div class="listingblock">
<div class="content">
<pre class="highlightjs highlight"><code data-lang="bash" class="language-bash hljs">dig _acme-challenge.thopenapi.com TXT</code></pre>
</div>
</div>
<div class="listingblock">
<div class="title">dig命令查询结果</div>
<div class="content">
<pre>; &lt;&lt;&gt;&gt; DiG 9.16.2 &lt;&lt;&gt;&gt; _acme-challenge.thopenapi.com TXT
;; global options: +cmd
;; Got answer:
...
<div class="sect4">
<h5 id="_申请通配符域名验证二">申请通配符域名验证（二）</h5>
<div class="paragraph">
...
<div class="sect3">
<h4 id="_申请方式二网站验证仅单域名">26.1.3. 申请方式二：网站验证（仅单域名）</h4>
<div class="paragraph">
<p><strong>未完待续</strong></p>
</div>
</div>
<div class="sect3">
<h4 id="_nginx_配置">26.1.4. Nginx 配置</h4>
<div class="listingblock">
<div class="content">
<pre>server {
    listen 80;
...
<div class="paragraph">
<p><a href="https://www.ssllabs.com/ssltest/" class="bare">https://www.ssllabs.com/ssltest/</a></p>
</div>
</div>
<div class="sect3">
<h4 id="_自动续签">26.1.5. 自动续签</h4>
<div class="paragraph">
<p>新增系统服务文件：</p>
</div>
<div class="listingblock">
...
systemctl start letsencrypt.timer</code></pre>
</div>
</div>
<div class="paragraph">
<p>设置开机启动：</p>
...
<div class="sect2">
<h3 id="_部分过时elasticstack使用教程">39.3. （部分过时）ElasticStack使用教程</h3>
<div class="paragraph">
...
<div class="dlist">
<dl>
<dt class="hdlist1">先启用相关字段的分析功能</dt>
</dl>
</div>
<div class="listingblock">
<div class="content">
<pre class="highlightjs highlight"><code data-lang="bash" class="language-bash hljs">curl -H "Content-Type: application/json" -X PUT 'http://localhost:9200/wecompany/_mapping/employee?pretty' -d '
{
    "properties": {
        "interests": {
            "type":     "text",
...
<div class="sectionbody">
<div class="sect2">
<h3 id="_安装配置_17">46.1. 安装配置</h3>
<div class="sect3">
<h4 id="_centos7_2">46.1.1. CentOS7</h4>
<div class="sect4">
...
<div class="sect3">
<h4 id="_域名解析_2">48.1.4. 域名解析</h4>
<div class="sect4">
<h5 id="_获取解析记录列表">获取解析记录列表</h5>
<div class="listingblock">
<div class="content">
<pre class="highlightjs highlight"><code data-lang="bash" class="language-bash hljs">aliyun alidns DescribeDomainRecords --DomainName thopenapi.com</code></pre>
</div>
</div>
</div>
<div class="sect4">
...
<div class="listingblock">
<div class="content">
<pre class="highlightjs highlight"><code data-lang="bash" class="language-bash hljs">aliyun alidns AddDomainRecord --DomainName thopenapi.com -RR _acme-challenge --TTL 600 --Type TXT --Value test</code></pre>
</div>
</div>
</div>
<div class="sect4">
...
<div class="listingblock">
<div class="content">
<pre class="highlightjs highlight"><code data-lang="bash" class="language-bash hljs">aliyun alidns DescribeSubDomainRecords --SubDomain _acme-challenge.data.thopenapi.com</code></pre>
</div>
</div>
<div class="listingblock">
<div class="content">
...
rabbitmqctl set_user_tags thcl administrator</pre>
</div>
</div>
<div class="paragraph">
...
<div id="footer">
<div id="footer-text">
Last updated 2020-06-23 23:44:45 +0800
</div>
</div>
